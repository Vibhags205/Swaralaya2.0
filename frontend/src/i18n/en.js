...
Professional singers know how physically demanding singing can be. It takes a lot of stamina and energy to sing onstage and bring the venue to life. That’s why singing, like any other physical activity, should involve a warm-up, as well as a vocal cool-down.
...
Sargam refers to the seven fundamental notes of Indian music (Sa, Re, Ga, Ma, Pa, Dha, Ni), acting as the musical alphabet or solfege. Alankars (or Paltas) are systematic, melodic patterns or "ornamentations" created using these notes, designed to train the voice or instruments for better control and speed

Definition: Sargam is the naming of notes; Alankar is the decorative pattern/exercise created by organizing those notes.

Purpose: Sargam is used to identify and sing notes, while Alankars are used to practice to improve technical skill, pitch accuracy, and speed.

Structure: Sargam is the raw material (\(Sa,Re,Ga,Ma...\)); Alankars are the structured arrangements of that raw material (e.g., \(SaReGa,ReGaMa,GaMaPa\)) in ascending (Aroha) and descending (Avroha) orders.     `,
...
Skipping Warm-ups: Starting intense practice without loosening vocal cords, which causes strain.
Ignoring the Tanpura: Singing without a tanpura leads to poor tuning and, thus, weak pitch control.
Poor Breathing Technique: Shallow breathing instead of diaphragm-based, controlled breath support.
Improper Posture & Tension: Singing with a stiff neck or shoulders, which limits vocal range and quality.
Ignoring Fundamentals: Skipping basic alankars (swar patterns) to rush into singing songs or complex ragas.`,
...
Together they create a spiritual musical experience.
  ...
  },
  {
    ...
    instrumentsTitle: "Carnatic Instruments",
      instruments: [
    { name: "Veena", desc: "Queen of Carnatic instruments",id: "veena", },
    { name: "Violin", desc: "Main accompaniment",id: "violin", },
    { name: "Tambura", desc: "Provides drone", id: "tambura" },
    { name: "Chitravina", desc: "Fretless slide instrument", id: "chitravina" },
    { name: "Flute", desc: "Bamboo wind instrument", id: "flute" },
    { name: "Nadaswaram", desc: "Temple ceremonial instrument", id: "nadaswaram" },
    { name: "Mridangam", desc: "Percussion backbone", id: "mridangam" },
    { name: "Ghatam", desc: "Clay pot rhythm", id: "ghatam" },
    { name: "Kanjira", desc: "Frame drum", id: "kanjira" },
    { name: "Morsing", desc: "Metal mouth harp", id: "morsing" },
  ],
